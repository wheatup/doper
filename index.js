...
class Doper {
	...
	_update() {
		...
		if (!isNaN(this._left) && !isNaN(this._right)) {
			...
			this.__right = this._parent.clientWidth * this._maxAnchorX - this._width * (1 - this._pivotX) - this._x;
		}
		...
		if (!isNaN(this._top) && !isNaN(this._bottom)) {
			...
			this.__bottom = this._parent.clientHeight * this._maxAnchorY - this._height * (1 - this._pivotY) - this._y;
		}
